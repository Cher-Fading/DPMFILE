...
#tot=0
for ((i = 1; i <= $3; i++)); do
    hadd -f $1_${i}_${2}_result$4.root $1_${i}/$1_${i}_*_result$4.root
#    num=0
passednum=0
...
echo "${1} ${i} total:$passednum"
#echo "${1} ${i} total:$num" >> /sphenix/user/xwang97/DPMJET/${1}_${2}_nofevt.txt
#echo "${1} ${i} passed:$passednum"
echo "${1} ${i} total:$passednum" >> /sphenix/user/xwang97/DPMJET/${1}_${2}_nofevt.txt
...
echo "${1} total:$passed">>${1}_${2}_nofevt.txt
